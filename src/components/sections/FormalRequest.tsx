      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            className="mb-12"
          >
            <Heart className="w-12 h-12 text-gold-600 mx-auto" />
          </motion.div>
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              With joyful hearts and great anticipation,
              <br />we request the honor of your presence
              <br />as we exchange our vows and begin our journey together.
            </p>
          </motion.div>
          ...
          >
            <p className="text-2xl font-serif text-gold-600">Saturday, September 14th, 2024</p>
            <p className="text-xl text-gray-700">Four o'clock in the afternoon</p>
            <p className="text-xl text-gray-700">The Grand Plaza Hotel</p>
            <p className="text-xl text-gray-700">123 Elegant Avenue, New York, NY</p>
          </motion.div>
