...
export function PhotoGallery() {
  ...
  const [cursorVariant, setCursorVariant] = useState<'default' | 'drag' | 'zoom'>('default');
  ...
  const filteredPhotos = activeCluster === 'all' 
    ? photos 
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-serif mb-6 text-gray-800">Our Moments</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Browse through our favorite memories and special moments.
            <span className="hidden md:inline"> Drag to explore and click to enlarge.</span>
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          {['all', 'engagement', 'ceremony', 'family', 'friends'].map((cluster) => (
            <motion.button
              key={cluster}
